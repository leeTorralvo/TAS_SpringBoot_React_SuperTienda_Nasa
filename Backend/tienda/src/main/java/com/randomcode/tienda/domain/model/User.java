package com.randomcode.tienda.domain.model;
...
public class User {
    ...
    public User(Long id, String name, String email, String password, Role role, String administratorCode) {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    //aqui van los getters y setters de cada atributo
    public Long getId() {
        return id;
    }
